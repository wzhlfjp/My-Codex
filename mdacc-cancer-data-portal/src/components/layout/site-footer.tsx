...
export async function SiteFooter() {
  ...
  return (
    <footer className="rounded-2xl border border-slate-200 bg-white px-5 py-4 shadow-[0_1px_2px_rgba(15,23,42,0.04)]">
      <div className="space-y-3 text-sm text-slate-600">
        <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
          <p className="max-w-3xl">MVP scaffold using local seed data. Discovery-first workflows remain the primary product focus.</p>
          <nav aria-label="Footer" className="flex flex-wrap items-center gap-3 text-sm">
            ...
            <Link href="/dashboard" className="text-slate-700 underline-offset-2 hover:text-slate-900 hover:underline">
              Dashboard
            </Link>
            <Link href="/researchers" className="text-slate-700 underline-offset-2 hover:text-slate-900 hover:underline">
              Researchers
            </Link>
