...
exports.NORMALIZED_VALUE_MAP = exports.RELATIONSHIP_TABLE_CONTRACTS = exports.CORE_TABLE_CONTRACTS = void 0;
exports.getAllRawCsvFileNames = getAllRawCsvFileNames;
exports.buildRawDataContractArtifact = buildRawDataContractArtifact;
exports.CORE_TABLE_CONTRACTS = [
    {
...
exports.RELATIONSHIP_TABLE_CONTRACTS = [
    {
...
function getAllRawCsvFileNames() {
    return [...exports.CORE_TABLE_CONTRACTS, ...exports.RELATIONSHIP_TABLE_CONTRACTS].map((contract) => contract.fileName);
}
function buildRawDataContractArtifact() {
    return {
        coreTables: exports.CORE_TABLE_CONTRACTS,
        relationshipTables: exports.RELATIONSHIP_TABLE_CONTRACTS,
