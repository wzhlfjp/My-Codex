...
- Lightweight compare/shortlist workflow is implemented for Researchers, Datasets, and Projects (tray, shareable compare URL, compare page, JSON export).
...
- Compare state supports one type at a time (researcher/dataset/project), with capped selection and shareable compare URLs.
