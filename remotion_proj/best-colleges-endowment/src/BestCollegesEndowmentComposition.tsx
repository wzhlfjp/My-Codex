...
import { useInterpolatedEndowmentRankings } from "./hooks/useInterpolatedEndowmentRankings";
import { theme } from "./styles/localTheme";

export const BestCollegesEndowment = () => {
  const frame = useCurrentFrame();
  const { entries, progress, year } = useInterpolatedEndowmentRankings();
